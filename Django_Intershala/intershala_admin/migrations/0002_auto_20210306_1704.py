...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('intershala_admin', '0001_initial'),
    ]

    operations = [
        migrations.CreateModel(
            name='IntershalaEmployee',
            fields=[
                ...
                ('salary', djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=Decimal('0'), default_currency='INR', max_digits=11, null=True)),
